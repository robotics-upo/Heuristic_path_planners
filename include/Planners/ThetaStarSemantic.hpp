#ifndef THETASTARSEMANTIC_HPP
#define THETASTARSEMANTIC_HPP
/**
...
namespace Planners
{
     ...
     * 
     */
    class ThetaStarSemantic : public ThetaStar
    {
    ...
    public:
         ...
         * 
         */
        ThetaStarSemantic(bool _use_3d, std::string _name );
         ...
         * @param _use_3d 
         */
        ThetaStarSemantic(bool _use_3d);
