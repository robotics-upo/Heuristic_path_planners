#ifndef CERES_CONSTRAINTS_2_CONT_FIX_GOAL
#define CERES_CONSTRAINTS_2_CONT_FIX_GOAL
...
class Ceres2_FixGoalContFunctor {

public:
    Ceres2_FixGoalContFunctor(double weight, Planners::utils::Vec3i local_goal): weight_(weight), local_goal_(local_goal) {}
