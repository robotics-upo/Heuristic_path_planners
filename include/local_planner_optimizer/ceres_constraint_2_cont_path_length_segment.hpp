#ifndef CERES_CONSTRAINTS_2_CONT_PATH_LEGTH_SEGMENT
#define CERES_CONSTRAINTS_2_CONT_PATH_LEGTH_SEGMENT
...
class Ceres2_PathLengthContSegmentFunctor {

public:
    Ceres2_PathLengthContSegmentFunctor(double weight, double t0, double t1): weight_(weight), t0_(t0), t1_(t1) {}
