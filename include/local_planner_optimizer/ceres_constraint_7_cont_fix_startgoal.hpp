#ifndef CERES_CONSTRAINTS_7_CONT_FIX_STARTGOAL
#define CERES_CONSTRAINTS_7_CONT_FIX_STARTGOAL
...
class Ceres7_FixStartGoalContFunctor {

public:
    Ceres7_FixStartGoalContFunctor(double weight, Planners::utils::Vec3i local_start, Planners::utils::Vec3i local_goal): weight_(weight), local_start_(local_start), local_goal_(local_goal) {}
