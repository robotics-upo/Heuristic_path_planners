#ifndef CERES_CONSTRAINTS_1_DIST_TO_OBSTACLE
#define CERES_CONSTRAINTS_1_DIST_TO_OBSTACLE
...
class Ceres1_ObstacleDistanceCostFunctor : public SizedCostFunction<1, 6>
    {
    public:
        Ceres1_ObstacleDistanceCostFunctor(Local_Grid3d* grid_, double weight): g_3D(grid_), weight_(weight)
        {}

        virtual ~Ceres1_ObstacleDistanceCostFunctor(void)
        {}
