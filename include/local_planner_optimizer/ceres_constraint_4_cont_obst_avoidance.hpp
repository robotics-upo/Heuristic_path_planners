#ifndef CERES_CONSTRAINTS_4_CONT_FIX_GOAL
#define CERES_CONSTRAINTS_4_CONT_FIX_GOAL
...
class Ceres4_FixGoalContFunctor {

public:
    Ceres4_FixGoalContFunctor(double weight, Planners::utils::Vec3i local_goal): weight_(weight), local_goal_(local_goal) {}
