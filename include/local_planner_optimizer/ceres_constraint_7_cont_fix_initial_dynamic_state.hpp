#ifndef CERES_CONSTRAINTS_7_CONT_FIX_INITIAL_DYNAMIC_STATE
#define CERES_CONSTRAINTS_7_CONT_FIX_INITIAL_DYNAMIC_STATE
...
class Ceres7_FixInitialDynamicStateFunctor {

public:
    Ceres7_FixInitialDynamicStateFunctor(
        double weight,
    ...
    bool operator()(const T* const stateCoeff, T* residual) const {
        ...
        // Target dimensionless derivatives derived from real-world values and T
        //   v_dimless_target = v_real * T / (2 * resolution)
        //   a_dimless_target = a_real * T^2 / (4 * resolution)
