#ifndef CERES_CONSTRAINTS_CONT_SMOOTHNESS
#define CERES_CONSTRAINTS_CONT_SMOOTHNESS
...
class SmoothnessContFunctor {

public:
    SmoothnessContFunctor(double weight): weight_(weight) {}
