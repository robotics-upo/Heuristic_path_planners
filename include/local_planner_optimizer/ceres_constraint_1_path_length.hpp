#ifndef CERES_CONSTRAINTS_1_PATH_LEGTH
#define CERES_CONSTRAINTS_1_PATH_LEGTH
...
class Ceres1_PathLengthFunctor {

public:
    Ceres1_PathLengthFunctor(double weight): weight_(weight) {}
