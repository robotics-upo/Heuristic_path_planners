#ifndef CERES_CONSTRAINTS_5_CONT_LIMIT_GRADIENTS
#define CERES_CONSTRAINTS_5_CONT_LIMIT_GRADIENTS
...
class Ceres5_ReduceGradientsContFunctor {

public:
    Ceres5_ReduceGradientsContFunctor(double weight): weight_(weight) {}
