#ifndef CERES_CONSTRAINTS_CONT_INIT_DISTANCE_TO_WP
#define CERES_CONSTRAINTS_CONT_INIT_DISTANCE_TO_WP
...
class DistanceToWPFunctor {

public:
    DistanceToWPFunctor (double weight, Planners::utils::Vec3i global_wp, double t_act): weight_(weight), global_wp_(global_wp), t_act_(t_act) {}
