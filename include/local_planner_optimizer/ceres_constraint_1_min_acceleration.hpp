#ifndef CERES_CONSTRAINTS_1_MIN_ACCELERATION
#define CERES_CONSTRAINTS_1_MIN_ACCELERATION
...
class Ceres1_MinAccelerationFunctor { // Minimiza la variación de la dirección de la velocidad (que mide la aceleración a módulo de la velocidad constante) ponderado con la distancia del desplazamiento entre WP

public:
    Ceres1_MinAccelerationFunctor(double weight): weight_(weight) {}
