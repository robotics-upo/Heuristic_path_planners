...
namespace Planners
{
    ...
    inline void ThetaStarM1::ComputeCost(Planners::utils::Node *_s_aux, Planners::utils::Node *_s2_aux)
    {
    ...
    inline unsigned int ThetaStarM1::computeG(const Planners::utils::Node *_current, Planners::utils::Node *_suc, unsigned int _n_i, unsigned int _dirs)
    {
