...
AStarSemantic::AStarSemantic(bool _use_3d):AStar(_use_3d, "astarsemantic") {}
AStarSemantic::AStarSemantic(bool _use_3d, std::string _name = "astarsemantic" ):AStar(_use_3d, _name) {}
