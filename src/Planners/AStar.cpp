  ...
  std::shared_ptr<rclcpp::Node> AStar::ros_node_ptr_ = nullptr;
    ...
    void AStar::configAlgorithm()
    {
      ...
      if (ros_node_ptr_ == nullptr){
        ...
        best_node_marker_.type = visualization_msgs::msg::Marker::SPHERE;

        aux_text_marker_ = explored_node_marker_;
        aux_text_marker_.type = visualization_msgs::msg::Marker::TEXT_VIEW_FACING;
    ...
    void AStar::publishOccupationMarkersMap()
    {
        ...
        sensor_msgs::msg::PointCloud2 occupancy_marker_msg;
        pcl::toROSMsg(occupancy_marker_, occupancy_marker_msg);
        occupancy_marker_pub_->publish(occupancy_marker_msg);
#endif
    }
...
#pragma GCC diagnostic ignored "-Wunused-parameter"
    ...
    void AStar::publishROSDebugData(const Planners::utils::Node *_node, const T &_open_set, const U &_closed_set)
    {
    ...
    inline unsigned int AStar::computeG(const Planners::utils::Node *_current, Planners::utils::Node *_suc, unsigned int _n_i, unsigned int _dirs)
    {
...
#pragma GCC diagnostic pop
    ...
    void AStar::exploreNeighbours(Planners::utils::Node *_current, const Vec3i &_target, node_by_position &_index_by_pos)
    {
