...
namespace Planners
{
    ...
    void LazyThetaStarM2::SetVertex(Planners::utils::Node *_s_aux)
    {
        if (!los_neighbour_)
        {
            ...
            for (const auto &i : direction)
            {
                ...
                if (successor2 == nullptr || successor2->occuppied)
                    continue;
    ...
    inline void LazyThetaStarM2::ComputeCost(Planners::utils::Node *_s_aux, Planners::utils::Node *_s2_aux)
    {
    ...
    inline unsigned int LazyThetaStarM2::computeG(const Planners::utils::Node *_current, Planners::utils::Node *_suc, unsigned int _n_i, unsigned int _dirs)
    {
