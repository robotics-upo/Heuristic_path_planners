...
namespace Planners
{
    ...
    void LazyThetaStarM1::SetVertex(Planners::utils::Node *_s_aux)
    {
    ...
    inline void LazyThetaStarM1::ComputeCost(Planners::utils::Node *_s_aux, Planners::utils::Node *_s2_aux)
    {
    ...
    unsigned int LazyThetaStarM1::computeG(const Planners::utils::Node *_current, Planners::utils::Node *_suc, unsigned int _n_i, unsigned int _dirs)
    {
